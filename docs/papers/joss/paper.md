...
![Example of hippocampal subfields segmentation. The segmentation results from HSF's segmentation models on a test observation.\label{sample}](figures/sample.png =100x)
